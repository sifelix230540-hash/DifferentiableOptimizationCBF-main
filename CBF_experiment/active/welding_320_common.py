...
class ExperimentConfig:
    ...
    workpiece_position: tuple[float, float, float] = (0.30, 5, 0.10)
    ...
    pre_approach_distance: float = 0.20
    pre_approach_lift: float = 0.08
    progress_step_limit: float = 0.03
    approach_progress_scale: float = 0.6
    return_progress_scale: float = 0.6
    ...
    ik_position_tolerance: float = 0.05
    ik_orientation_tolerance: float = 0.35
    ik_max_candidates: int = 8
    ik_random_seeds: int = 12
    ik_jitter_scale: float = 0.15
